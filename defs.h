...
#define MARTY_CDT_USED(x)                   (void)(x)

//----------------------------------------------------------------------------
//! Подавление варнинга о неиспользованном аргументе (аналогично MARTY_CDT_USED, для совместимости)
#define MARTY_CDT_ARG_USED(x)               (void)(x)
